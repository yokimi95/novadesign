...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Novago Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrError.authMessage': 'Your Novago Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Novago Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Novago Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Novago Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.signInRequired.amr': 'Novago is not signed in',
  ...
  'chat.runError.title.runtimeConfig': "Novago error",
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Novago to the latest version, which ships a compatible runtime.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Novago — switch to a different version and retry.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker Novago needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  ...
  'settings.welcomeTitle': 'Welcome to Novago',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Novago will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Novago reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Novago Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Novago daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Novago.',
  ...
  'settings.amrAccountStatus': 'Novago Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Novago as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Novago team',
  'settings.privacyConsentKicker': 'Help us improve Novago',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Novago performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Novago starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Novago could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Novago to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Novago is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Novago as context.',
  'settings.mcpRunningNote': 'Keep Novago running. Restart your coding agent after setup.',
  ...
  'entry.discordAriaWithOnline': 'Join the Novago Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.xAria': 'Follow @NovagoHQ for updates',
  ...
  'entry.followXLabel': 'Follow @NovagoHQ on X',
  ...
  'entry.followLinkedinLabel': 'Follow Novago on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Novago on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use Novago Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss Novago Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Novago plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Novago Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Novago project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Novago Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Novago workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Novago and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Novago',
  'pluginCard.contributeTitle': 'Contribute plugin to Novago with a pull request',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Novago from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Novago is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Novago everywhere',
  'useEverywhere.modalTitle': 'Use Novago everywhere',
  'useEverywhere.modalSubtitle': 'Drop Novago into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Novago works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Novago is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Novago as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Novago at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Novago from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Novago as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Novago ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Novago tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Novago app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Novago running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Novago extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Novago and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Novago extras)',
  ...
  'entry.githubStarAria': 'Star Novago on GitHub',
  ...
  'newproj.locationDefault': 'Novago projects',
  ...
  'avatar.amrConsole': 'Novago Cloud',
  ...
  'socialShare.openDesignSection': 'Share Novago',
  'socialShare.openDesignTitle': 'Novago on GitHub',
  'socialShare.openDesignText': 'Novago is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Novago: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Novago: {title}\n{url}\nNovago repo: {repo}',
  ...
  'brandEnrichment.body': "Novago will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Novago to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Novago to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Novago is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Novago? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @NovagoHQ on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Novago on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Novago on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Novago on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to Novago Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToNovago': 'Share to Novago',
  'assistant.shareToNovagoBusy': 'Preparing package…',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Novago — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Novago — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Novago project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Novago should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Novago {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Novago is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Novago could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Novago is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Novago',
  'updater.quitFailedBody': 'The installer is open, but Novago could not quit. Quit Novago before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Novago will close and open the installer.',
  'updater.readyVersion': 'Novago {version} is ready. Novago will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Novago will close and open the installer.',
  'updater.reinstallReadyVersion': 'Novago {version} requires a full reinstall. Novago will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'Novago {version} is here',
  ...
  'dsManager.createBody': 'Teach Novago your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Novago follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Novago your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Novago turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in Novago. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Novago — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Novago. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve Novago",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend Novago to a colleague or friend?",
  ...
  'chat.designSystemStatus.description': 'Novago is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use Novago's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Novago built for design work. Output is noticeably better in layout, structure, and completeness.",
